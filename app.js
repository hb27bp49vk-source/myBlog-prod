...
const safeUrl=(value='')=>{const url=String(value).trim();return /^(https?:\/\/|\.\/|\.\.\/|\/assets\/)/.test(url)&&!/[\u0000-\u001F\s]/.test(url)?url:''};
